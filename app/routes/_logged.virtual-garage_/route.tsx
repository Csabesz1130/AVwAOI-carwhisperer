...
function VirtualGaragePage() {
  ...
  const handleUpdateCategory = async (userCarId: string, category: string, field: string) => {
    try {
      await updateUserCar({
        where: { id: userCarId },
        data: { [field]: category },
            ...
            >
              <p>
                ...
                <Select
                  ...
                  style={{ width: 120 }}
                  onChange={value => handleUpdateCategory(userCar.id, value, 'ownershipStatus')}
                >
              ...
              <p>
                ...
                <Select
                  style={{ width: 120 }}
                  onChange={value => handleUpdateCategory(userCar.id, value, 'primaryUse')}
                >
              ...
              <p>
                ...
                <Select
                  style={{ width: 120 }}
                  onChange={value => handleUpdateCategory(userCar.id, value, 'engineType')}
                >
      ...
      >
        <Form form={form} onFinish={handleAddCar} layout="vertical">
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: 'Please select fuel efficiency importance' }]}
          >
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: 'Please select emissions concern' }]}
          >
